...
public class Game {
	 ...
	 /** TODO: Figure out if we need the level code **/
	 ...
	 public boolean onTouchEvent(MotionEvent event) {
		 if (mRunning) {
			 //TODO: Should simplify touch events in our use case
